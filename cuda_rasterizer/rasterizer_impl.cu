...
CudaRasterizer::GeometryState CudaRasterizer::GeometryState::fromChunk(char*& chunk, size_t P)
{
	...
	// obtain(chunk, geom.features, P * NUM_FEATURE_CHANNELS, 128);	TODO can we remove this?
	...
	bool debug)
{
	...
	// const float* colors_ptr = colors_precomp != nullptr ? colors_precomp : geomState.rgb; // TODO remove this!
